<?php session_start();
	...
	$sql="select * from tblsinhvien where idlop='".$_SESSION['idlop']."'";
                            ...
                            <tr>
                            	<?php 
                            		while ($row = mysqli_fetch_array($kq)) {
                            		    ...
                            		    echo '<td><a href="Delete_sv.php?id='.$id.'"  title=""><button type="button" class="btn btn-danger">Xóa</button></a></td>';
